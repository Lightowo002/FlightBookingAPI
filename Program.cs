...
// Habilitar Swagger siempre en producción para que puedas hacer pruebas de endpoints directo en la web
app.UseSwagger();
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "FlightBookingAPI v1");
    c.RoutePrefix = string.Empty; // Esto hace que Swagger sea la página de inicio al entrar al enlace de Railway
});

// Comentamos la redirección HTTPS temporalmente porque Railway ya maneja el SSL/HTTPS externamente
